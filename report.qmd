...
\todo[inline]{The objective function and likelihood estimates for each observation, should be similar; REVIEW ALL WAIC CALCULATIONS}

\todo[inline]{Check the messages around the xtable chunks. Use SupressMessage() and SupressWarnings() as needed}
